...
**Phase 3** — Medium effort; deferred from Phase 1 (home list polish, not core chat MVP).
...
- [message-pagination.md](../phase1/message-pagination.md) — helpful for accurate "first unread" divider
